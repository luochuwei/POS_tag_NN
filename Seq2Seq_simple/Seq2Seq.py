...
class Seq2Seq(object):
    ...
    def define_layers(self):
        ...
        # word decoder
        word_decoder_layer = WordDecoderLayer_new(self.cell, rng, str(i + 2), (encoder_layer.out_size, self.out_size), sents_codes, self.mask_y, self.hidden_size_decoder, self.is_train, self.batch_size, self.drop_rate)
