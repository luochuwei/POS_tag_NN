...
X_seqs, y_seqs, i2w, w2i, tf, data_x_y = get_data.processing(x_path, y_path, threshold, 0, 3, batch_size)
...
print "save data dic..."
save_data_dic("data/i2w-test.pkl", "data/w2i-test.pkl", i2w, w2i)
...
print "save model..."
save_model("0420-new.model", model)
