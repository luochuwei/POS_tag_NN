...
w2i = cPickle.load(open(code_path + "/" + r'STC_data/w2i40000_0419.pkl', 'rb'))
...
plt.show()
Fig.savefig("visualizations(dict_40000).png", format = "png")